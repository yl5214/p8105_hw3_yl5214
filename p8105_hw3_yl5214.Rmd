...
brfss_2010=brfss |> 
  ...
  filter(n_obs>=7)
```
#### Comment: In 2002, `r print(pull(brfss_2002, state))` 6 states were observed at 7 or more locations. In 2010, `r print(pull(brfss_2010, state))` 14 states were observed at 7 or more locations.
